...
from DLDA.utils import BaseDataset_window_loto, calculate_metrics
...
if __name__ == "__main__":
    ...
    for latent in dim:
        ...
        for sub in range(1, args.subjects + 1):
            ...
            for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
                ...
                #print(f'Test accuracy: {sum(y_pred==y_true)/y_true.shape[0]}')

                Y_preds.append(y_pred)
                Y_true.append(y_true)
                
            Y_preds_total.append(np.concatenate(Y_preds))
    ...
    sio.savemat('/data2/lalalagegrx/EEGemotion/SEED/Results/SPDNet-DLDA/SPDNetDLDA_1layer_loto_dim.mat', {'dim':dim, 'acc':acc_total})
