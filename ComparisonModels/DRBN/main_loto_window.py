...
from DRBN.utils import BaseDataset_window_loto, calculate_metrics
...
if __name__ == "__main__":
            ...
            for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
                ...
                for epoch in range(args.epochs):
                    ...
                    for batch_idx, (inputs, targets) in enumerate(trDL):
                        ...
                        #     inputs[i] = inputs[i] + torch.eye(args.channels) * 1e-1
    ...
    sio.savemat('/data2/lalalagegrx/EEGemotion/SEED/Results/DRBN/DRBN_loto.mat', {'dim':dim, 'acc':acc_total})
