...
from SPDNet.utils import BaseDataset_window, BaseDataset_static, calculate_metrics
...
if __name__ == "__main__":
    ...
    sio.savemat('/data2/lalalagegrx/EEGemotion/SEED/Results/SPDNet/SPDNet_1layer_loso_dim.mat', {'dim':dim, 'acc':acc_total})
